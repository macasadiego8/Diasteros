...
#nullable disable
#nullable restore
#line 4 "C:\ProysCicloIII\ProjectMoviesDiasteros\Client\Pages\Components\MovieList.razor"
...
#nullable restore
#line 14 "C:\ProysCicloIII\ProjectMoviesDiasteros\Client\Pages\Components\MovieList.razor"
       
    [Parameter] public List<Movie>Movies { get; set; }
 
    async Task DeleteMovie(Movie movie)
    {
        var confirmar = await js.Confirm($"¿Desea borrar la película {movie.Name}?");
        if (confirmar)
        {
